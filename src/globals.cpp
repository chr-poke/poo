...
std::shared_ptr<move> leerMove = std::make_shared<statusMove>(normalType, 0, "Leer");
...
std::shared_ptr<move> growlMove = std::make_shared<statusMove>(normalType, 0, "Growl");
std::shared_ptr<move> scratchMove = std::make_shared<physicalMove>(normalType, 40, "Scratch");
std::shared_ptr<move> focus_energyMove = std::make_shared<statusMove>(normalType, 0, "Focus Energy");
...
std::shared_ptr<move> howlMove = std::make_shared<statusMove>(normalType, 0, "Howl");
std::shared_ptr<move> sand_attackMove = std::make_shared<statusMove>(normalType, 0, "Sand Attack");
